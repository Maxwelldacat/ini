...
@section('content')
<div class="min-h-screen bg-[#032f38] text-white px-12 py-10">

    <a href="/" class="inline-block bg-[#196D7D] text-white px-4 py-2 rounded-lg hover:bg-[#145663] ">
        ← Kembali
    </a>

    <h1 class="text-3xl font-bold text-center mb-10 text-[#57AOB2]">
        Portofolio Kami
    </h1>
